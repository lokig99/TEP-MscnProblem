...
{
	return cGenerateSolution(iIterations, 0, iSeed, dResultQuality);
}
...
CMscnSolution CRandomSearch::cGenerateSolution(int iIterations, int iInitPopulation, int iSeed, double & dResultQuality)
{
